...
function Home()
{
    ...
    return(
      ...
      <h2 className="typer"> 
        <Typewriter options={{strings:["A Full Stack Web Developer", "Front End Web Developer","Back End Developer","Certified from LinkedIn","Member of Google Developer Community","Member of MLSA (Microsoft Learn Student Ambassador)"],
       ...
       <section id="social">
         ...
         <a href="https://drive.google.com/file/d/16qZVUCvLrhY41CB6882BOke72LJVcm_a/view?usp=drive_link" target="_blank" id="resumeButton">
